...
function needContext(proxy, names) {
  ...
  for (const prop of names) {
    if ((isScriptable(prop) && isFunction$4(proxy[prop]))
      || (isIndexable(prop) && isArray$a(proxy[prop]))) {
      return true;
    }
  }
  return false;
...
var CChart = React.forwardRef(function (props, ref) {
    ...
    var _g = React.useState(), chart = _g[0], setChart = _g[1];
    React.useImperativeHandle(ref, function () { return chart; }, [chart]);
    var renderChart = function () {
        ...
        if (customTooltips$1) {
            ...
            defaults.plugins.tooltip.external = customTooltips;
        }
    ...
    var updateChart = function () {
        if (!chart)
            return;
        if (options) {
            chart.options = __assign({}, options);
        }
    ...
    var canvas = function (ref) {
        return (React__default['default'].createElement("canvas", { height: height, width: width, ref: ref, id: id, onClick: function (e) {
                handleOnClick(e);
            }, "data-testid": "canvas", role: "img" }, fallbackContent));
    };
    return wrapper ? (React__default['default'].createElement("div", __assign({ className: "chart-wrapper " + className }, rest), canvas(canvasRef))) : (canvas(canvasRef));
});
CChart.propTypes = {
...
var CChartBar = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "bar", ref: ref }))); });
CChartBar.displayName = 'CChartBar';
var CChartBubble = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "bubble", ref: ref }))); });
CChartBubble.displayName = 'CChartBubble';
var CChartDoughnut = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "doughnut", ref: ref }))); });
CChartDoughnut.displayName = 'CChartDoughnut';
var CChartLine = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "line", ref: ref }))); });
CChartLine.displayName = 'CChartLine';
var CChartPie = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "pie", ref: ref }))); });
CChartPie.displayName = 'CChartPie';
var CChartPolarArea = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "polarArea", ref: ref }))); });
CChartPolarArea.displayName = 'CChartPolarArea';
var CChartRadar = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "radar", ref: ref }))); });
CChartRadar.displayName = 'CChartRadar';
var CChartScatter = React.forwardRef(function (props, ref) { return (React__default['default'].createElement(CChart, __assign({}, props, { type: "scatter", ref: ref }))); });
